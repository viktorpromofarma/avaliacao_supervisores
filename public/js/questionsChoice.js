document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
        if (multipleChoiceRadio.checked) {
            const respostaInputs = choicesContainer.querySelectorAll('input[name="respostas[]"]');
            const notaInputs = choicesContainer.querySelectorAll('input[name="notas[]"]');
            ...
            if (!isValid) {
                ...
                alert("Preencha todos os campos de resposta e nota antes de continuar.");
            }
        }
    });
